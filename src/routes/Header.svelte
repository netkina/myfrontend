 ...
 <div class="w-full flex flex-row gap-5">
	<div class="w-[5%]">
		<picture>
				...
				<img src={Image} alt="logo" class="w-auto"/>
			</picture>
	</div>
...
<div class="-mb-4 flex w-full max-w-sm flex-col gap-6">
 <Tabs.Root value="account">
  <Tabs.List>
   <Tabs.Trigger value="account">Мониторинг</Tabs.Trigger>
   <Tabs.Trigger value="password">Настройки</Tabs.Trigger>
  </Tabs.List>
...
<div class="w-full flex flex-row gap-5 justify-end">
	<div class="w-[5%]">
		<picture>
				<source srcset={Image} type="image/svg" />
				<img src={Image} alt="logo" class="w-auto"/>
